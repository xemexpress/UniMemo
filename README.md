...
交收時地是交收的時段和地點。<u>交收點與原計劃路線相近</u>、<u>交收時間與新計劃路線的預計抵達時間相符</u>的可行情況下時，用戶（作為潛在接單人）才會接收到Memo。
...
![流程](https://raw.githubusercontent.com/xemexpress/UniMemo/master/exported/README/Flow.jpg)