<div style="text-align: right; font-size:50%">Updated: 2019.8.28.1</div>
...
4. 支付承諾按金。
   ...
   ```markdown
   系統會以商品在合作商戶中的最高售價計算承諾按金，即 代買商品最高售價的總額（即 墊支部分）加上此總額的10%（即 酬金部分，可附加小費）。交收時，你將會用此按金支付由商戶核實並經接單人代買的商品，（若有）餘額將返還至你的電子錢包。若你無法支付承諾按金，Memo將被拒絕發出。
   ```
